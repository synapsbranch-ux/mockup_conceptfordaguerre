const driveImage = (id, width = 1800) =>
  `https://lh3.googleusercontent.com/d/${id}=w${width}`

export const images = {
  hero: driveImage('1ulD3VmDYty7frnenoRJGkYqsOg7KKndt', 2200),
  portrait: driveImage('12DISDlvgaHPUQE5qHJ_do4Opvs6sq2pJ', 1200),
  journey: driveImage('1TZf5hRzotCcYR5iEkTIFd9sCM84oDpDG'),
  mba: driveImage('1qOGSsIvQxXAVnunMmRIRTFYQJRiG388d'),
  datakle: driveImage('1O6JTKFaZankIZs3oXRnqx5WRQrNBKCt2'),
  agronomy: driveImage('1hKT19ha1AdlvXlEzkZ_G0dFohXMQep56'),
  economics: driveImage('1pfO-otl64o3bhFozB2_8mFeKYzFWdBYN'),
  evaluation: driveImage('10N53WvQgO9HbzT0QmGGgEBtRxKF39tSc'),
  research: driveImage('1y-AL9is7_-iB6aRl3r2YtkP6ofzX3T54'),
  strategy: driveImage('1ZBNQMUfKmX6OZzCCJ-pFm-nA4_cIm6AT'),
  efficiency: driveImage('18fcTlbvyBqLhlzqm7RAW7mUVsYksvNLT'),
  decision: driveImage('1sZZerq1trXEt6CiVKc_VMPLPs1lwmB5u'),
  powerbi: driveImage('1yIfSHC26SgW_5fVKiZLATb3y1C_B_QY6'),
  automation: driveImage('1CjBs0zo17c0sufBW8kxg-PKlKpFBp65U'),
  haitiImpact: driveImage('1NwjpVBq83O8UOThbJp2IMpaHeH7AO0Qj'),
  haitiData: driveImage('1F9ejkzI7oTuZzkbeagM4DVWoRuw2TlhN'),
  education: driveImage('1_95ckaW4bu_UXbexe-1pRMMd9s3fVaQF'),
}
