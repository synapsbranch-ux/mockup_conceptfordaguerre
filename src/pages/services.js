...
export default function Services() {
  return (
    <Layout>
      ...
      <section className="services-hero shell"><img src={images.datakle} alt="Univers visuel de Datakle" /><div><span>Mission</span><p>Rendre l’analytique accessible et actionnable afin d’améliorer la décision, la performance et l’impact des organisations.</p></div></section>
      ...
      <section className="vision-panel">
        ...
        <div className="vision-image"><img src={images.haitiImpact} alt="Vision data et développement pour Haïti" /></div>
      </section>
