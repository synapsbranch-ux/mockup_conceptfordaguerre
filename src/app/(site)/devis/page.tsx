...
const PublicQuotePage = async () => {
  const [sessionUser, payload] = await Promise.all([getSessionUser(), getPayloadClient()])
      ...
      <main id="contenu" className="section-pad">
        <div className="shell">
          <header style={{ maxWidth: '46rem' }}>
            ...
            <p className="lede">
              Quelques lignes suffisent pour démarrer. Vous recevrez une réponse par courriel, et
              une proposition détaillée si le projet s’y prête.
            </p>
          </header>
          ...
          {sessionUser && (
            <p className="muted" style={{ marginTop: '1.5rem' }}>
              ...
              pour suivre la demande, l’enregistrer en brouillon et y joindre des documents.
            </p>
          )}
