...
const PublicBookingPage = async () => {
  ...
  const preview = open
    ? groupSlotsByDay(
        await getAvailableSlots(meetingTypes[0]),
        "America/Toronto",
      ).slice(0, 4)
    : [];
        ...
        <div className="shell">
          ...
          {!open ? (
            <p className="muted" style={{ marginTop: "3rem" }}>
              ...
              <Link href="/contact">Écrivez-nous</Link> et nous conviendrons
              d’un moment.
            </p>
          ) : (
            <>
              ...
              {preview.length > 0 && (
                <section style={{ marginTop: "3rem" }}>
                  ...
                  <p className="muted" style={{ marginTop: ".5rem" }}>
                    Horaires indiqués à l’heure de Montréal. Les créneaux seront
                    affichés dans votre propre fuseau lors de la réservation.
                  </p>
                    ...
                    {preview.map((day) => (
                      <div key={day.date}>
                        ...
                        >
                          {day.slots
                            .slice(0, 8)
                            .map((slot) => formatTime(slot.startAt))
                            .join(" · ")}
                          {day.slots.length > 8 ? " …" : ""}
                        </p>
                      </div>
              ...
              <div style={{ marginTop: "3rem" }}>
                {sessionUser ? (
                  <Link
                    ...
                    href="/espace-client/rendez-vous/reserver"
                  >
                    Choisir un créneau
                  </Link>
                ) : (
                  <>
                    ...
                    <p className="muted" style={{ marginTop: "1rem" }}>
                      Un compte est nécessaire pour réserver : il permet de
                      recevoir les rappels et de reporter ou annuler la
                      rencontre.{" "}
